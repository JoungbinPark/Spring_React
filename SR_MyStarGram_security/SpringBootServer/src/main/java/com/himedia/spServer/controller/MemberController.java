...
public class MemberController {
    ...
    public HashMap<String, Object> getMemberInfo(@RequestParam("nickname") String nickname){
        HashMap<String, Object> result = new HashMap<>();
        Member member = ms.getMemberByNickname(nickname);
        result.put("cUser", member);

        List<Follow> followingList = ms.getFollowings(nickname);
        List<Follow> followerList = ms.getFollowers(nickname);
